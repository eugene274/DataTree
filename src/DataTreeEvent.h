...
//     bool GetProcessFlag(){return ProcessFlag;}
    ...
    double GetVertexPositionComponent(int idx, int jdx = 0){return VertexPosition[jdx][idx];}
    double GetVertexQuality(int idx = 0){return VertexQuality[idx];}
    ...
    void SetVertexPosition(double fX, double fY, double fZ, int idx = 0){VertexPosition[idx][0]=fX; VertexPosition[idx][1]=fY; VertexPosition[idx][2]=fZ;}
    void SetVertexPositionComponent(int idx, double fValue, int jdx = 0){VertexPosition[jdx][idx] = fValue;}
    void SetVertexQuality(double fValue, int idx = 0){VertexQuality[idx] = fValue;}
    void SetHasVertex(bool pValue = true, int idx = 0){HasVertex[idx] = pValue;}
...
private:
    ...
    double VertexPosition[2][3];	//Position of the vertex
    bool HasVertex[2];	//Position of the vertex
    double VertexQuality[2];		//Quality of vertex fit
